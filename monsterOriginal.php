...
if($_POST){
    ...
    fwrite($handle, "<b>" . $name . ' (' . $date . ') ' . "(" . $rating . " stars) " . "</b>:<br/>" . "<b>Retailer(s): </b>" . $location . "<br>" . "<b>Price paid: </b>" . $pricePaid . "<br>" . $summary . "<br/>");
    fclose($handle);
}
?>
<!DOCTYPE html>
...
<form action="" method="POST">
    ...
    Rating: <input type="number" min="1" max="5" name="rating" placeholder="4">
